...
export const BoltSlashIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.35 4.536A9.75 9.75 0 0121.75 12c0 .341-.018.678-.052 1.01M12.99 9.342A5.625 5.625 0 0118.375 12a5.625 5.625 0 01-5.385 5.658M12.99 9.342V4.536M12.99 9.342L11.007 12m1.983-2.658L9.75 21.75l1.22-6.874m-2.22 4.374L3 12.375l2.09-2.625m2.22 4.374L6.29 15.125m10.16-1.575L3 3l18 18z" />
    </svg>
);
